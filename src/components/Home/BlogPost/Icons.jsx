   ...
   dark:text-slate-200"
    >
      <div className="flex justify-start items-center">
        <div
          className="w-20 h-12 mr-4 flex justify-around items-center border border-slate-500 rounded-full        
        ...
        >
          ...
          >
            <Icon path={mdiHeartOutline} size={iconSize} />
            <div className="text-md">{post.likes}</div>
          </button>
        </div>
        <div
          className="w-20 h-12 mr-4 flex justify-around items-center border border-slate-500 rounded-full        
        ...
        >
          <button
            ...
            className="w-full h-full flex justify-around items-center"
          >
            <Icon path={mdiChatOutline} size={iconSize} />
            <div className="text-md">{post.comments.length}</div>
          </button>
        </div>
      </div>
      <div className="relative w-20 h-12 mr-4 flex justify-around items-center">
        <button
          id={post.id}
          data-icon-id={iconId}
          className="w-full h-full flex justify-around items-center border border-slate-500 rounded-full text-md
           hover:bg-slate-300 hover:text-slate-100 hover:cursor-pointer active:scale-95 transition
           dark:border-slate-300 dark:hover:bg-slate-800 dark:hover:text-slate-100 dark:text-slate-300"
